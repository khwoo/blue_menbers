...
var vm = new Vue({
    ...
    mounted: function() {
        ...
        var contentinfo_1 = {
            ...
            title : '사용방법안내'
            ,content : [
                 '1. 블루멤버스 포인트로 교환권을 구매합니다.</br>'
                ,'2. 상단 보관함에서 교환권 쿠폰번호를 확인합니다.</br>'
                ,'3. 쿠폰번호를 복사하고 제주항공 사이트에 로그인합니다.</br>'
                ,'제주항공</br>http://www.jejuair.net/jejuair/kr/main.do </br>'
                ,'4. 마이페이지 > 나의쿠폰 메뉴에서 블루멤버스에서 </br>구매한 쿠폰번호를 등록합니다.</br>'
                ,'반드시 사전등록해야 쿠폰사용이 가능합니다.</br>'
                ,'5. 항공권 예매 시 해당 쿠폰을 선택하여 사용하시면 </br>혜택이 적용됩니다.</br>'
            ].join('')
        ...
        var contentinfo_2 = {
            title : '유의사항'
            ,content : [
                 '구매한 쿠폰은 2019년 04월 30일까지 사용가능합니다.</br>'
                ,'항공권 결제 시점이 19년 04월30일 이내여야 적용되며,</br>'
                ,'2019년 12월 31일전까지 스케쥴되어 있는 모든 항공편에 </br>할인적용됩니다.</br>'
                ,'블루멤버스 이달의 혜택 보관함에서 쿠폰번호를 확인하시면,'
                ,'쿠폰사용완료로 간주합니다.'
                ,'유효기간 내 사용하지 않은 쿠폰에 대해서는 사용취소 및 구매취소가 가능합니다.</br>'
